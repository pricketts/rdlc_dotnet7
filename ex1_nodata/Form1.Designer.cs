namespace ex1_nodata
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label5.Name = "label5";
            label5.Size = new Size(939, 15);
            label5.TabIndex = 5;
            label5.Text = "Step 5. Then in the Form Load event set the ReportViewer Local Report to the embedded resource and RefreshReport(), you would also want to set the DataSource on a real report";
            // 
            // Form1
            // 
